...
```yaml
# Rahul - DevOps & Cloud Engineer | Beginner MLOps

profile:
  name: Rahul
  title: DevOps & Cloud Engineer
  focus: Beginner in MLOps

skills:
  cloud_platforms: [AWS, Azure, GCP]
  containerization: [Docker, Kubernetes]
  deployment_tools: [ArgoCD, Prometheus, Grafana, EFK Stack]
  infra_as_code: [Terraform, Packer, Ansible]
  version_control: [GitHub]
  scripting_languages: [Shell, Python]
